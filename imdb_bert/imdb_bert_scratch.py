...
if __name__ == '__main__':
    ...
    local_model_path = r"E:\model\bert-base-uncased"
    ...
    model = BertScratch.from_pretrained(local_model_path)
    ...
    training_args = TrainingArguments(
        ...
        logging_dir='./logs',  # directory for storing logsmetric
        logging_steps=100,
        save_strategy="no",
        eval_strategy="epoch"
    )
    ...
    result_output.to_csv("../results/bert_scratch.csv", index=False, quoting=3)
