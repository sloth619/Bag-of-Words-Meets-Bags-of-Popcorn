...
class Capsule(nn.Module):
    ...
    def forward(self, inputs):
        ...
        if self.bidirectional:
            dim_capsule = self.num_hiddens * 2
        else:
            dim_capsule = self.num_hiddens
        u_hat_vecs = u_hat_vecs.view((batch_size, input_num_capsule,
                                      self.num_capsule, dim_capsule))
...
if __name__ == '__main__':
    ...
    result_output.to_csv("../results/capsule_lstm.csv", index=False, quoting=3)
